...
namespace CloudSaveSample
{
    ...
    public class CloudSaveSample : MonoBehaviour
    {
        ...
        private async void Awake()
        {
           ...
           // await ForceSaveSingleData("tolga", "123");


            //await ForceSaveObjectData("object_key", test.samples[0]);
          ...
          //  await ForceDeleteSpecificData("object_key");
            ...
            //test.samples[0]=await RetrieveSpecificData<SampleObject>("object_key");
